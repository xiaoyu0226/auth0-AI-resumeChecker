...
from helpers.open_search_store import OpenSearchStore
...
class RAG:
    def __init__(self):
        ...
        self.vector_store = OpenSearchStore.from_documents(documents)    # uncomment for using openSearch
        # self.vector_store = MemoryStore.from_documents(documents)    # uncomment for using FAISS
